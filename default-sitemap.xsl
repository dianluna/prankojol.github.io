...
>
	...
	<a href="https://dianluna.github.io/prankojol.github.io/"><span>Beranda</span></a>
	...
	<a href="https://dianluna.github.io/prankojol.github.io/"><span>Beranda</span></a>
			...
			<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
					...
					<a href="https://dianluna.github.io/prankojol.github.io/sitemap.xml"><span>Sitemap Index</span></a>
						<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
	...
	<div id="content-head">
		...
		<xsl:choose>
			<xsl:when test="$fileType='RSS'">
				<p>Dibuat oleh <a href="https://aioseo.com/?utm_source=WordPress&#038;utm_campaign=liteplugin&#038;utm_medium=xml-sitemap" target="_blank" rel="noreferrer noopener">All in One SEO</a>, this is an RSS Sitemap, meant to be consumed by search engines like Google or Bing.</p>
				<p>
					Anda dapat menemukan informasi lebih lanjut tentang RSS sitemap di <a href="https://www.sitemaps.org/" target="_blank" rel="noreferrer noopener">sitemaps.org</a>.				</p>
			</xsl:when>
			<xsl:otherwise>
				<p>Dibuat oleh <a href="https://aioseo.com/?utm_source=WordPress&#038;utm_campaign=liteplugin&#038;utm_medium=xml-sitemap" target="_blank" rel="noreferrer noopener">All in One SEO</a>, ini adalah Sitemap XML, dimaksudkan untuk dikonsumsi oleh mesin pencari seperti Google atau Bing. </p>
				<p>
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				and was generated on 17 Juni 2025 at 5:00 pm			</p>
		</xsl:if>
	</div>
</xsl:template>
	...
	<xsl:variable name="priorityLabel">
		<xsl:choose>
			...
			<xsl:when test="$priorityLevel = 'high'">Tinggi</xsl:when>
		</xsl:choose>
	</xsl:variable>
	...
	<a href="https://dianluna.github.io/prankojol.github.io/"><span>Beranda</span></a>
		...
		<div class="empty-sitemap__buttons">
			<a href="https://dianluna.github.io/prankojol.github.io/" class="button">Back to Homepage</a>
					</div>
